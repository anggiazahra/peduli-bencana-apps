    ...
    const tampilanBanjir = () => {
      content.innerHTML = `
        <div class="card-body">
            ...
            <p tabindex="0">Bencana alam banjir adalah bencana yang sering sekali terjadi di Indonesia. Curah hujan yang tinggi serta adanya pasang surut air laut menjadi penyebab utama terjadinya banjir. Selain itu, faktor perilaku manusia juga berpengaruh, seperti pengolahan lahan yang tidak tepat, membuang sampah sembarangan terutama pada saluran air seperti sungai, membangun pemukiman dilahan yang mudah banjir.</p>
            <p tabindex="0"><strong>Adapun banjir terbagi menjadi 3 kategori, yaitu:</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Penyebab Banjir:</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Ketika Terjadi Banjir</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Kegiatan Setelah Terjadi Banjir</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Mitigasi dan Upaya Pengurangan Resiko Bencana</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Dampak Banjir</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Referensi:</strong></p>
            <ul>
    ...
    const tampilanTanahLongsor = () => {
      content.innerHTML = `
        <div class="card-body">
            ...
            <p tabindex="0">Tanah Longsor  merupakan salah satu bentuk gerakan tanah atau batuan, atau yang disebut pencampuran keduanya, menuruni atau keluar lereng akibat dari terganggunya kestabilan tanah atau batuan yang menjadi pondasi lereng tersebut. Tanah longsor terjadi akibat adanya gangguan kestabilan tanah / batuan penyusun lereng</p>
            <p tabindex="0"><strong>Tanah Alami Terjadinya Tanah Longsor</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Daerah Rawan Tanah Longsor</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Apa yang dilakukan saat terjadinya longsor</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Setelah Terjadi Tanah Longsor</strong></p>
            <ul tabindex="0">
    ...
    const tampilanGempaBumi = () => {
      content.innerHTML = `
        <div class="card-body">
            ...
            <p tabindex="0"><strong>Sebelum Terjadi Gempa Bumi</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Alat yang harus selalu ada disekitar Anda</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Ketika Terjadi Gempa Bumi</strong></p>
            <p tabindex="0"><strong>Di dalam rumah</strong></p>
            <p tabindex="0">Anda bisa merasakan getarannya untuk beberapa saat. Selama  waktu ini, lindungi diri Anda dan keluarga Anda. Pergi ke bawah meja untuk melindungi diri dari benda jatuh. Jika Anda tidak memiliki meja, tutupi kepala Anda dengan bantal. Matikan kompor segera setelah Anda menyalakannya.</p>
            <p tabindex="0"><strong>Di luar rumah</strong></p>
            <p tabindex="0">Lindungi kepala Anda dan hindari bahan berbahaya. Di area perkantoran dan industri, kaca dan rambu yang jatuh dapat menimbulkan bahaya. Lindungi kepala Anda dengan sesuatu yang Anda bawa, seperti tangan atau tas.</p>
            <p tabindex="0"><strong>Di gedung, mall, bioskop dan lantai dasar mall</strong></p>
            <p tabindex="0">Jangan menyebabkan  atau menjadi korban  kepanikan. Ikuti  petunjuk dari petugas atau satpam.</p>
            <p tabindex="0"><strong>Di kereta api</strong></p>
            <p tabindex="0">Pegang tiang penopang agar tidak terbalik jika kereta berhenti tiba-tiba. Harap diam setelah penjelasan kondektur. Kesalahpahaman informasi dari staf kereta dan stasiun dapat menyebabkan kepanikan.</p>
            <p tabindex="0"><strong>Di gunung</strong><strong> /</strong><strong> pantai</strong></p>
            <p tabindex="0">Tanah longsor dapat terjadi dari puncak gunung. Langsung ke tempat yang aman. Bahaya tsunami berawal dari pantai. Jika Anda merasakan getaran yang menunjukkan tanda-tanda tsunami, segera mengungsi ke bukit.</p>
            <p tabindex="0"><strong>Di dalam mobil</strong></p>
            <p tabindex="0">Ketika gempa besar terjadi, Anda merasa roda mobil terbuka. Anda kehilangan kendali atas mobil Anda dan sulit dikendalikan. Tinggalkan persimpangan dan parkir mobil Anda di sisi kiri jalan. Ikuti petunjuk di radio mobil. Jika Anda perlu mengungsi, keluar dari mobil dan biarkan mobil tidak terkunci.</p>
            <p tabindex="0"><strong>Setelah Terjadi Gempa Bumi</strong></p>
            <ul tabindex="0">
    ...
    const tampilanTsunami = () => {
      content.innerHTML = `
        <div class="card-body">
            ...
            <p tabindex="0"><strong>Ketika Terjadi Tsunami</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Tiga Langkah Tanggap Tsunami</strong></p>
            <ol tabindex="0">
    ...
    const tampilanGunungMeletus = () => {
      content.innerHTML = `
        <div class="card-body">
            ...
            <p tabindex="0">Letusan gunung dapat terjadi karena endapan magma di dalam  bumi didorong keluar oleh gas  bertekanan tinggi. Dalam proses letusan, gunung berapi terbentuk. Efek dari letusan gunung berapi dapat mengancam jiwa dan memakan harta benda manusia.</p>
            <p tabindex="0"><strong>Sebelum Terjadi Letusan</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Saat Terjadi Letusan</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Setelah Terjadi Letusan</strong></p>
            <ul tabindex="0">
    ...
    const tampilanAbrasiGelombangTinggi = () => {
      content.innerHTML = `
        <div class="card-body">
            ...
            <p tabindex="0"><strong>Dampak Abrasi Dan Gelombang Pasang</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Ketika Terjadi Gelombang Pasang</strong></p>
            <ul tabindex="0">
    ...
    const tampilanAnginRibut = () => {
      content.innerHTML = `
        <div class="card-body">
            ...
            <p tabindex="0">Angin ribut/puting beliung adalah angin kencang yang berputar sehingga pangkal awan cumulonimbus menyentuh daratan dengan kecepatan hingga 175 km/jam, namun intensitasnya lebih rendah dari tornado. Badai mengaduk lautan, menciptakan gelombang besar dan kuat.</p>
            <p tabindex="0"><strong>Tanda-Tanda Terjadinya Angin Puting Beliung</strong></p>
            <ul tabindex="0">
                <li>Terlihat gumpalan awan gelap, besar, dan tinggi.</li>
                <li>Petir dan gemuruh terlihat dari kejauhan.</li>
            </ul>
            <p tabindex="0"><strong>Penanganan Saat Terjadinya Angin Puting Beliung</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Penanganan Setelah Terjadinya Angin Puting Beliung</strong></p>
            <ul tabindex="0">
    ...
    const tampilanKekeringan = () => {
      content.innerHTML = `
        <div class="card-body">
            ...
            <p tabindex="0">Kekeringan merupakan kapasitas air yang tersedia jauh di bawah kebutuhan air, baik untuk keberlangsungan hidup, pertanian, kegiatan ekonomi, serta lingkungan.</p>
            <p tabindex="0"><strong>Gejala Terjadinya Kekeringan</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Dampak Kekeringan</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Mitigasi Serta Upaya Pengurangan Resiko Kekeringan</strong></p>
            <ul tabindex="0">
    ...
    const tampilanKebakaran = () => {
      content.innerHTML = `
        <div class="card-body">
            ...
            <p tabindex="0">Kebakaran merupakan musibah yang tidak terduga datangnya bisa kapan saja dan dimana saja, sehingga dibutuhkan kegiatan mitigasi maupun pelatihan-pelatihan pemadaman kebakaran bagi siapa saja yang mempunyai wewenang atas terjadinya musibah tersebut.</p>
            <p tabindex="0"><strong>Sistem Pemadaman</strong></p>
            <p tabindex="0"><strong>Sistem Isolasi</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Sistem Pendinginan</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Sistem Urai</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>ALAT PEMADAM</strong></p>
            <p tabindex="0"><strong>Media pemadaman jenis padat:</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0"><strong>Media pemadaman jenis cair:</strong></p>
            <ul tabindex="0">
                <li>Air</li>
                <li>Busa (Foam)</li>
                <li>Soda</li>
            ...
            <p tabindex="0"><strong>Media pemadaman jenis gas:</strong></p>
            <ul tabindex="0">
                <li>Gas asam arang</li>
                <li>Gas zat lemas</li>
                <li>Zat argon</li>
            </ul>
            <p tabindex="0"><strong>Dry Chemical</strong></p>
            <p tabindex="0">Cara pemakaian:</p>
            <p tabindex="0">Harus diperhatikan adanya arah angin. Jika angin bertiup terlalu kuat maka penggunakan dry chemical ini tidak efektif.</p>
            <p tabindex="0">Arahkan pancaran pemotong nyala api dan usahakan dapat terbentuk semacam awan / asap untuk menutup nyala api tersebut.</p>
            <p tabindex="0"><strong>Pasir / Tanah</strong></p>
            <ul tabindex="0">
            ...
            <p tabindex="0">Cara pemakaian:</p>
            <p tabindex="0">Pasir / tanah ditaburkan mulai dari tepi hingga seluruh permukaan yang terbakar tertutup rata.</p>
            <p tabindex="0"><strong>Selimut / Karung Goni</strong></p>
            <ul tabindex="0">
                <li>Cocok untuk kebakaran kompor (minyak) dan semua jenis kebakaran, kecuali listrik.</li>
                <li>Bahan murah dan mudah didapat.</li>
            </ul>
            <p tabindex="0">Cara pemakaian:</p>
            <p tabindex="0">Basahi karung goni dengan air kemudian tutupkan secara rata pada bagian yang terbakar. Jika dengan satu karung tidak cukup, tambah lagi.</p>
            <p tabindex="0"><strong>Referensi:</strong></p>
            <ul>
                <li><a href="http://www.mitigasi-bencana.com/">http://www.mitigasi-bencana.com/</a></li>
                <li><a href="https://bpbd.kedirikota.go.id/view/bencana-alam-gunung-meletus">https://bpbd.kedirikota.go.id/view/bencana-alam-gunung-meletus</a></li>
